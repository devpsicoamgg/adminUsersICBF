...
const { AdministrativeAssistant, Contract, Coordinator } = require("../../../3.-DataBase/dataBaseConfig.js");
const sendEmail = require("../../../6.-Mail/sendEmail.js");

console.log("1️⃣.-Controller 📤POST -ADMIN-ROUTE-➡️ ", AdministrativeAssistant);

const createAdministrativeCollaborator = async (
  firstName,
  secondName,
  firstLastName,
  secondLastName,
  ...
  try {
    const AdministrativeAssistantUser = await AdministrativeAssistant.create({
      firstName,
      secondName,
      firstLastName,
      secondLastName,
    ...
    if (!contractId  ) {
      throw new Error(
        "contractId, coordinatorId es obligatorio para crear un docente"
      );
    }
...
module.exports = { createAdministrativeCollaborator };
